    ...
    <>
        ...
        <button className='back-btn-uui' onClick={handleBackClick}>Back</button>
            ...
            <div className="s1-project-ui-header">
                <p>Mobile UI/UX Designs</p>
                <p>Here are some of my latest mobile UI/UX projects, focused on intuitive layouts, smooth user flows, and modern interface design tailored for real user needs.</p>
            </div>
            <div className="s1-project-ui-project-ui-cont">
                {
                    dataAppUI.map((project) => (
